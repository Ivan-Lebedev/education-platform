...
from app.application.interfaces.services import TokenService
from app.infrastructure.config import get_settings


class InvalidTokenError(Exception):
    "Исключение, возникающее при ошибке JWT."


class JwtTokenService(TokenService):
    "Реализация контракта сервиса работы с JWT с помощью библиотеки pyjwt."
